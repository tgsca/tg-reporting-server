...
function getDefectCalculationBasis(input = {}) {
    ...
    basis['closed']['woPrio'] = c.woPrio ? c.woPrio : 0;
    basis['closed']['sum'] =
        basis.closed.urgent + basis.closed.high + basis.closed.medium + basis.closed.low + basis.closed.woPrio;
    ...
    basis['inRetest']['woPrio'] = iR.woPrio ? iR.woPrio : 0;
    basis['inRetest']['sum'] =
        basis.inRetest.urgent +
        basis.inRetest.high +
        basis.inRetest.medium +
        basis.inRetest.low +
        basis.inRetest.woPrio;
    ...
    basis['inInstallation']['woPrio'] = iInst.woPrio ? iInst.woPrio : 0;
    ...
    basis['inImplementation']['woPrio'] = iImpl.woPrio ? iImpl.woPrio : 0;
    ...
    basis['inClarification']['woPrio'] = iC.woPrio ? iC.woPrio : 0;
    ...
    basis['new']['woPrio'] = n.woPrio ? n.woPrio : 0;
    basis['new']['sum'] = basis.new.urgent + basis.new.high + basis.new.medium + basis.new.low + basis.new.woPrio;
    ...
    basis['rejected']['woPrio'] = rej.woPrio ? rej.woPrio : 0;
    basis['rejected']['sum'] =
        basis.rejected.urgent +
        basis.rejected.high +
        basis.rejected.medium +
        basis.rejected.low +
        basis.rejected.woPrio;
    ...
    basis['sum']['woPrio'] =
        ...
        basis.new.woPrio +
        basis.rejected.woPrio;
    basis['sum']['sum'] = basis.sum.urgent + basis.sum.high + basis.sum.medium + basis.sum.low + basis.sum.woPrio;
